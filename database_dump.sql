...
create index groupmembers_grp_groupId_fk
...
create index grp_users_email_fk
	on grp (owner)
;

alter table groupmembers
	add constraint groupmembers_grp_groupId_fk
		foreign key (groupId) references grp (groupId)
;
...
alter table grp
	add constraint grp_users_email_fk
